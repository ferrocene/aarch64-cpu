...
impl Writeable for Reg {
    ...
    fn set(&self, value: u64) {
        ...
        unsafe {
            match imm {
                0b0000 => {}
                0b0001 => core::arch::asm!("msr daifset, #0x1", options(nomem, nostack)),
                0b0010 => core::arch::asm!("msr daifset, #0x2", options(nomem, nostack)),
                0b0011 => core::arch::asm!("msr daifset, #0x3", options(nomem, nostack)),
                0b0100 => core::arch::asm!("msr daifset, #0x4", options(nomem, nostack)),
                0b0101 => core::arch::asm!("msr daifset, #0x5", options(nomem, nostack)),
                0b0110 => core::arch::asm!("msr daifset, #0x6", options(nomem, nostack)),
                0b0111 => core::arch::asm!("msr daifset, #0x7", options(nomem, nostack)),
                0b1000 => core::arch::asm!("msr daifset, #0x8", options(nomem, nostack)),
                0b1001 => core::arch::asm!("msr daifset, #0x9", options(nomem, nostack)),
                0b1010 => core::arch::asm!("msr daifset, #0xa", options(nomem, nostack)),
                0b1011 => core::arch::asm!("msr daifset, #0xb", options(nomem, nostack)),
                0b1100 => core::arch::asm!("msr daifset, #0xc", options(nomem, nostack)),
                0b1101 => core::arch::asm!("msr daifset, #0xd", options(nomem, nostack)),
                0b1110 => core::arch::asm!("msr daifset, #0xe", options(nomem, nostack)),
                0b1111 => core::arch::asm!("msr daifset, #0xf", options(nomem, nostack)),
